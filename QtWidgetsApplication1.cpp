...
void Movies2::connectSignalsAndSlots()
{
	...
	QObject::connect(this->ui.undoButton, &QPushButton::clicked, this, &Movies2::undo);
	QObject::connect(this->ui.redoButton, &QPushButton::clicked, this, &Movies2::redo);

	this->ui.undoShortcut = new QShortcut(QKeySequence(Qt::CTRL | Qt::Key_Z), this);
	this->ui.redoShortcut = new QShortcut(QKeySequence(Qt::CTRL | Qt::Key_Y), this);

	QObject::connect(this->ui.undoShortcut, &QShortcut::activated, this, &Movies2::undo);
	QObject::connect(this->ui.redoShortcut, &QShortcut::activated, this, &Movies2::redo);

	QObject::connect(this->ui.viewTable, &QPushButton::clicked, this, [this]() {
		TableModel* model = new TableModel{ this->ctrl };
